      ...
      subject: "Share Link" //  for email
        ...
        return (
          <View style={styles.container}>
              <View style={{ flex: 7 }}>
                <ShareSheet visible={this.state.visible} onCancel={this.onCancel.bind(this)} style={{position: 'absolute'}}>
              ...
              <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
                ...
                <View style={{alignItems: 'center'}}>
                   <TouchableOpacity  onPress={this.onOpen.bind(this)}>
                      <Image source={imgDefaultShare} style={{width: 35, height: 30, backgroundColor: 'transparent'}}/>
                   </TouchableOpacity>
                   <View>
                      <Text style={[{fontWeight: 'bold', paddingTop: 5, color:'#737373', fontSize: 8}]}>COMPARTILHAR</Text>
                   </View>
                </View>
              </View>
              </LinearGradient>                         
