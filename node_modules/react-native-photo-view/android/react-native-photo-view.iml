...
<module external.linked.project.id=":react-native-photo-view" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-photo-view" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7" inherit-compiler-output="false">
    ...
    <content url="file://$MODULE_DIR$">
      ...
      <excludeFolder url="file://$MODULE_DIR$/build/intermediates/exploded-aar/me.relex/photodraweeview/1.0.0/jars" />
    ...
    <orderEntry type="library" exported="" name="photodraweeview-1.0.0" level="project" />
